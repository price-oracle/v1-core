...
FOUNDRY_PROFILE=docs forge doc --out tmp/price-technical-docs
...
tail -n +5 tmp/price-technical-docs/src/SUMMARY.md >> docs/src/SUMMARY.md
...
cp -R tmp/price-technical-docs/src/solidity/interfaces docs/src/solidity/
